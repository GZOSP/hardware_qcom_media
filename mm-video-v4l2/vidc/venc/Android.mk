...
libmm-venc-inc      += $(TOP)/$(call project-path-for,qcom-media)/mm-video-v4l2/vidc/common/inc
libmm-venc-inc      += $(TOP)/$(call project-path-for,qcom-media)/mm-core/inc
libmm-venc-inc      += $(TOP)/$(call project-path-for,qcom-media)/libstagefrighthw
...
libmm-venc-inc      += $(TOP)/$(call project-path-for,qcom-media)/libc2dcolorconvert
libmm-venc-inc      += $(TOP)/$(call project-path-for,qcom-media)/hypv-intercept
